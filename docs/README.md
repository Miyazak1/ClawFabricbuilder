...
10. [Working Context State Architecture](WORKING_CONTEXT_STATE_ARCHITECTURE.md)
11. [Frontend Experience and Design System Roadmap](FRONTEND_EXPERIENCE_AND_DESIGN_SYSTEM_ROADMAP.md)
12. [Composer Intent Routing Architecture](COMPOSER_INTENT_ROUTING_ARCHITECTURE.md)
13. [Builder Session and Task Address Architecture](BUILDER_SESSION_TASK_ADDRESS_ARCHITECTURE.md)
14. [Persistent Agent Task Context Architecture](PERSISTENT_AGENT_TASK_CONTEXT_ARCHITECTURE.md)
15. [Storage Lifecycle Governance](STORAGE_LIFECYCLE_GOVERNANCE.md)
16. [Draft Checkpoint Architecture](DRAFT_CHECKPOINT_ARCHITECTURE.md)
17. [Lifecycle Hooks Architecture](LIFECYCLE_HOOKS_ARCHITECTURE.md)
18. [Work Capsule Architecture](WORK_CAPSULE_ARCHITECTURE.md)
19. [Trusted Work and Collaboration Architecture](TRUSTED_WORK_AND_COLLABORATION_ARCHITECTURE.md)
20. [Builder Conversation and Task Stream MVP](BUILDER_CONVERSATION_TASK_STREAM_MVP.md)
21. [Coding Agent Source Reference Audit](CODING_AGENT_SOURCE_REFERENCE_AUDIT_2026_07_22.md)
22. [Implementation Plan](IMPLEMENTATION_PLAN.md)
23. [Legacy Future Plan Coverage Matrix](LEGACY_FUTURE_PLAN_COVERAGE_MATRIX.md)
24. [Builder Architecture](ARCHITECTURE.md)
25. [Legacy Migration Map](LEGACY_MIGRATION_MAP.md)
26. [Release Evidence - 2026-07-22](RELEASE_EVIDENCE_2026_07_22.md)
27. [Extraction and documentation provenance](../provenance/extraction-manifest.json)
