...
assert.equal(preloadConstants.get('SUBMIT_CHANNEL'), generationChannels[3]);
assert.equal(preloadConstants.get('GENERATION_STARTED_CHANNEL'), generationChannels[4]);
assert.equal(preloadConstants.get('GENERATION_OUTPUT_CHANNEL'), generationChannels[5]);
assert.equal(preloadConstants.get('RETRY_GENERATE_CHANNEL'), generationChannels[6]);
assert.equal(preloadConstants.get('ANSWER_CHANNEL'), generationChannels[7]);
assert.equal(preloadConstants.get('RESTORE_DRAFT_CHANNEL'), generationChannels[8]);
assert.equal(preloadConstants.get('REJECT_DRAFT_CHANNEL'), generationChannels[9]);
assert.equal(preloadConstants.get('CANCEL_CHANNEL'), generationChannels[10]);
assert.equal(preloadConstants.get('STEER_CHANNEL'), generationChannels[11]);
assert.equal(preloadConstants.get('AVAILABILITY_CHANNEL'), generationChannels[12]);
